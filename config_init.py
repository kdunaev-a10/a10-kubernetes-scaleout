...
#    (a10_status, a10_msg)=sdk.get(uri='/axapi/v3/hostname')
#    if a10_status != 200:
#       print "!!!!IS NOT 200 !!", a10_status, a10_msg
#
#    sdk.post(uri = '/axapi/v3/hostname', payload = hostname)
#    sdk.get(uri='/axapi/v3/hostname')
...
#       SO_CONFIG = False
    ...
    if not SO_CONFIG:
       ...
       #(s,r)=sdk.post(uri='/axapi/v3/scaleout/cluster', payload=cluster_config)
...
#      }
#
#    (s,r)=sdk.post(uri='/axapi/v3/scaleout/apps', payload=cluster_config)
#
#    if s != 200:
#         print "ERROR:", s, r
