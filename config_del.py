...
#### find all cluster devices
    ...
    print ('/axapi/v3/scaleout/cluster/'+str(so_cluster)+'/cluster-devices/device-id/'+ID+'/')
    (s,r)=sdk.delete(uri='/axapi/v3/scaleout/cluster/'+str(so_cluster)+'/cluster-devices/device-id/'+ID+'/')
    print "."
    print "."
